...
const Blog = () => {
    ...
    const {
        positive_reactions_count, reading_time_minutes, title, comments_count, published_at,
    } = blog
        ...
        <div className="max-w-2xl px-6 py-16 mx-auto space-y-12">
            <article className="space-y-8 dark:bg-gray-100 dark:text-gray-900">
                <div className="space-y-6">
                    <h1 className="text-3xl font-bold md:tracking-tight md:text-3xl">{title}</h1>
                    ...
                    <div className="flex items-center -mx-4 overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap dark:bg-gray-100 dark:text-gray-800">
                        ...
                        {/* Bookmark Button */}
                        <div onClick={()=>handleBookmark(blog)} className="bg-primary p-3 ml-5 rounded-full cursor-pointer hover:bg-opacity-20 bg-opacity-20 hover:scale-105 overflow-hidden">
                        <MdBookmarkAdd color="#F92FD3" className="text-2xl"></MdBookmarkAdd>
                        </div>
